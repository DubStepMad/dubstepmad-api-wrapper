...
export const blur = ({ image, amount }: { image: string, amount: number }) => fetchImage("blur", { image, amount });
...
export const wide = ({ image, factor }: { image: string, factor: number }) => fetchImage("wide", { image, factor });
